...
class CfgWeapons 
{
	...
	class OPTREZ_SRS99C_base 
	{
		...
		flashsize = 0.5;
		forceoptics = 0;
		handanim[] = {"OFP2_ManSkeleton","srs99c\anim\Handanim_SR99.rtm"};
		hiddenselections[] = {};
		...
		opticszoommax = 1.1;
		opticszoommin = 0.375;
		picture = "\SRS99C\UI\gear_srs99c_x_CA";
		primary = 10;
		recoil = "recoil_gm6";
		...
		class WeaponSlotsInfo {
			...
			class CowsSlot {
				access = 1;
				compatibleitems[] = {"optic_Arco", "optic_aco", "optic_ACO_grn", "optic_hamr", "optic_Holosight", "OPTRE_SRS99D_Scope"};
		...
		class GunParticles {
			class FirstEffect {
				...
				positionname = "Usti hlavne";
					 ...
					 */
                    modes[] = {"Single"}; // Firing modes such as must have a defined class bellow "Single", "Burst"
